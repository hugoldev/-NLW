...
//  NLW
//
//  Created by Hugo Lopes on 13/12/24.
//
...
class WelcomeView: UIView {
    ...
    private let descriptionLabel: UILabel = {
        let label = UILabel()
        label.text = "Get perk coupons to use at your favorite establishments"
    ...
    private func setupTips() {
        ...
        let tip1 = TipsView(icon: icon1,
                            ...
                            description: "Discover the best places in your city")
        let tip2 = TipsView(icon: UIImage(named: "qrcode") ?? UIImage(),
                            title: "Get coupons",
                            description: "Get coupons to use at your favorite establishments")
        let tip3 = TipsView(icon: UIImage(named: "ticket") ?? UIImage(),
                            title: "Use your coupons",
                            description: "Use your coupons and get discounts")
