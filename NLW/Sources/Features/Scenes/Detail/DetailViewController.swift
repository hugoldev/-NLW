...
class DetailsViewController: UIViewController {
    ...
    private func configureDetails(){
        ...
        infoStackView.addArrangedSubview(createInfoRow(iconName: "ticket", text: "\(place.coupons) coupons available"))
       ...
       let regulationText =  """
        . Coupons are valid only on-site
